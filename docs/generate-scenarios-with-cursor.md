...
- Product: {PRODUCT} ("apollo" or "biberk"). Use QA terminology. For biBerk, use “View Quote” and “Your Quote > Add-On Coverage”. For Apollo, include a login step if needed.
...
How to use
1) Replace {PRODUCT} with “apollo” or “biberk”.
